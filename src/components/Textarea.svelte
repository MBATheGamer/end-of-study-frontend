...
<div class="relative w-full m-2">
  <textarea bind:value={value} id="description" class="block px-3 pb-3 pt-6 bg-transparent text-black font-semibold w-full rounded-lg border-2 border-base-content appearance-none focus:outline-none peer resize-none disabled:bg-base-content/25" placeholder=" " {rows} {disabled} />
