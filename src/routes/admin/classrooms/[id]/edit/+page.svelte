...
<div class="ml-16 w-[600px]">
  <h1 class="ml-12 mb-3 font-bold text-3xl">Edit Classroom #{classroom.id}</h1>
  <form class="ml-10 ">
    ...
    <div class="relative m-2">
      <textarea bind:value={classroom.description} id="description" class="block px-3 pb-3 pt-6 w-full bg-transparent rounded-lg border-2 border-base-content appearance-none focus:outline-none peer resize-none" placeholder=" " rows="8" />
