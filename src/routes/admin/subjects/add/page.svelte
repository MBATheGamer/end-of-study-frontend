  ...
  <form class="needs-validation">
    <div class="row g-3">
      ...
      <div class="form-floating col-6">
        <select bind:value={subject.classroomId} class="form-select form-control rounded-3" id="country" required>
      ...
      <div class="form-floating col-6">
        <select bind:value={subject.teacherId} class="form-select form-control rounded-3" id="country" required>
        ...
        <label for="country" class="form-label ms-2">Teacher</label>
        <div class="invalid-feedback">
