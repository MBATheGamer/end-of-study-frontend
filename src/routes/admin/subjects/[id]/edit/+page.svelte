  ...
  <div class="book">
    <div class="cover">
      <label for="checkbox-cover">
        <h1 class="absolute text-5xl font-bold top-36 left-8">Edit Subject #{id}</h1>
      </label>
    </div>
      ...
      <div class="front-page">
        <form>
          ...
          <div class="flex my-2">
            ...
            <div class="relative w-full mx-2">
              <select bind:value={teacherId} class="select w-full h-[64px] border-base-content border-2" required>
          ...
          <div class="relative m-2">
            <textarea bind:value={subject.description} id="description" class="block px-3 pb-3 pt-6 w-full bg-transparent rounded-lg border-2 border-base-content appearance-none focus:outline-none peer resize-none" placeholder=" " rows="9" />
