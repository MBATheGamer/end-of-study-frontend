      ...
      <div class="front-page">
        <form>
          <div class="relative m-2">
            <input value={userRequest.cin} type="text" id="cin" class="block px-3 pb-3 pt-6 bg-transparent text-black font-semibold w-full rounded-lg border-2 border-base-content appearance-none focus:outline-none peer" placeholder=" " />
          ...
          <div class="flex my-2">
            <div class="relative w-full mx-2">
              <input bind:value={userRequest.firstName} type="text" id="firstName" class="block px-3 pb-3 pt-6 text-black bg-transparent font-semibold w-full rounded-lg border-2 border-base-content appearance-none focus:outline-none peer" placeholder=" " />
          ...
          <div class="relative m-2">
            <input value={userRequest.email} type="text" id="email" class="block px-3 pb-3 pt-6 bg-transparent text-black font-semibold w-full rounded-lg border-2 border-base-content appearance-none focus:outline-none peer" placeholder=" " />
          ...
          <div class="flex my-2">
            <div class="relative w-full mx-2">
              <select bind:value={userRequest.roleId} class="select w-full h-[64px] bg-transparent text-black border-base-content border-2" required>
            ...
            {#if (userRequest.roleId === 3)}
              <div class="relative w-full mx-2">
                <select bind:value={userRequest.classroomId} class="select w-full h-[64px] bg-transparent text-black border-base-content border-2" required>
