...
<div class="relative flex flex-col justify-center h-screen overflow-x-hidden">
	<slot />
	<label class="absolute bottom-4 right-4 btn btn-ghost btn-circle swap swap-rotate">
